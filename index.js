...
module.exports = {
    ...
    'rules': {
        ...
        // - Rules that are recommended but contradict the A3 styleguide
        ...
        'no-multi-spaces': 'off', // for import formatting
        'no-multi-str': 'error',
        // 'no-new': 'off',
        // 'no-new-func': 'off',
        ...
        'no-undef': 'warn', // eslint:recommended // CONFIG variable handling
        // 'no-undef-init': 'off',
        // 'no-undefined': 'off',
        ...
        // -------------------------------------------------------------------
        '@babel/new-cap': ['error', {'properties': false}],
